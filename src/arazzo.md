...
| <a name="stepAction"></a>action                   |                                    `string`                                     | Describes the intent of the message flow. Indicates whether the step will _send (publish)_ or _receive (subscribe)_ to a message on a channel described in an AsyncAPI document. Only applicable for `asyncapi` steps. Possible values are `"send"` or `"receive"`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
