...
- [Workflows Specification](#workflows-specification)
  ...
  - [Specification](#specification)
    ...
    - [Specification Path Expressions](#spec-path-expressions)
...
A specification path expression allows an operation in an OpenAPI specification that does not have an operationId defined to be referenced as part of a [steps](#step-object).
