...
<a name="workflowSteps"></a>steps | [[Step Object](#step-object) \| [Reference Object](#reference-object)] | **REQUIRED**. An ordered list of steps where each step represents a call to an API operation or to another workflow. If a Reference Object is provided, it MUST refer to a Step.
